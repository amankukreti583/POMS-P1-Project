<%@page import="com.revature.Model.Pizza"%>
		...
		<div class="container  px-2"
			...
			<div class="table-responsive">
				...
				<table id="MyTable" class="table table-striped" cellspacing="0"
					...
					<tbody>
						<%
						ArrayList<Pizza> list = (ArrayList<Pizza>)(request.getAttribute("data"));
						for (Pizza piz : list) {
							AdminDao ad = new AdminDao(ConnectionFactory.getConnection());
							ArrayList<Pizza> itemList = (ArrayList<Pizza>) ad.selectPizzaDetails();
						%>
						<tr>
							<td class="pid"><%=piz.getPizzaId()%></td>
							<td class="pname"><%=piz.getPizzaType()%></td>
							<td class="pcategory"><%=piz.getPizzaCategory()%></td>
							<td class="psize"><%=piz.getPizzaSize()%></td>
							<td class="pprice"><%=piz.getPizzaPrice()%></td>
							...
							<td><a href="DeletePizzaServlet?pz_id=<%=piz.getPizzaId()%>"><i
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="mx-1 mx-md-4" action="EditPizzaServlet" method="post">
						...
						<div class="d-flex flex-row align-items-center mb-4">
							<i class="fasme="id" value=""
									class="form-cont fa-user fa-lg me-3 fa-fw"></i>
							<div class="form-outline flex-fill mb-0">
	...
	<script type="text/javascript">
		$(function() {
			...
			$(".edit").click(function() {
				...
				var name = $(this).parents("tr").find(".pname").text();
				var category = $(this).parents("tr").find(".pcategory").text();
				var price = $(this).parents("tr").find(".pprice").text();
				var size = $(this).parents("tr").find(".psize").text();
