...
<body>
	...
	<div id="topbar" class="d-flex align-items-center fixed-top">
		<div
			...
			<div class="contact-info d-flex align-items-center">
				<i class="bi bi-phone d-flex align-items-center"><span>+91
						9948363378</span></i> <i class="bi bi-clock d-flex align-items-center ms-4"><span>
						Mon-Sat: 10AM - 10PM</span></i>
			</div>
	...
	<header id="header" class="fixed-top d-flex align-items-cente">
		<div
			...
			<h1 class="logo me-auto me-lg-0">
				<a href="LandingPage.jsp">Pizza Oven</a>
			</h1>
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					...
					<li class="dropdown"><a href="#"><span>Items</span> <i
							class="bi bi-chevron-down"></i></a>
						<ul>
							<li class="dropdown"><a href="#"><span>Pizza</span> <i
									class="bi bi-chevron-right"></i></a>
								<ul>
									<li><a href="index_pizza.jsp"><input
											class="buttonHover butStyle" type="submit"
											value="ADD PIZZA DETAILS"></a></li>
									<li><form action="DisplayPizzaServlet" method="get">
											<input class="buttonHover butStyle" type="submit"
												value="UPDATE/DELETE PIZZA">
										</form></li>
                  ...
                  <li><a href="#">Deep Drop Down 5</a></li> -->
							...
							<li class="dropdown"><a href="#"><span>BEVERAGE</span> <i
									class="bi bi-chevron-right"></i></a>
								<ul>
									<li><a href="index_beverage.jsp">ADD BEVERAGE</a></li>
									<li>
										<form action="DisplayBeverageServlet" method="get">
											<input class="buttonHover butStyle" type="submit"
												value="DISPLAY/UPDATE/DELETE BEVERAGE">
										</form>
									</li>
									<!-- <li><a href="#">Deep Drop Down 3</a></li>
                  <li><a href="#">Deep Drop Down 4</a></li>
                  <li><a href="#">Deep Drop Down 5</a></li> -->
							...
							<li class="dropdown"><a href="#"><span>COOKIE</span> <i
									class="bi bi-chevron-right"></i></a>
								<ul>
									<li><a href="index_cookie.jsp">ADD COOKIE</a></li>
									<li><a href="DisplayCookieServlet">DISPLAY/UPDATE/DELETE
											COOKIE</a></li>
									<!-- <li><a href="#">Deep Drop Down 3</a></li>
                  <li><a href="#">Deep Drop Down 4</a></li>
                  <li><a href="#">Deep Drop Down 5</a></li> -->
	...
	<section id="hero" class="d-flex align-items-center">
		<div class="container position-relative text-center text-lg-start"
			...
			<div class="row">
				<div class="col-lg-8">
					<h1>
						Welcome to <span>Pizza Oven</span>
					</h1>
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="box" data-aos="zoom-in" data-aos-delay="100">
							<span>01</span>
							<h4>Ambience</h4>
							<p>What better place to make memories while eating your
								favourite food at our beautiful store.</p>
						</div>
					</div>
					...
					<div class="col-lg-4 mt-4 mt-lg-0">
						<div class="box" data-aos="zoom-in" data-aos-delay="200">
							<span>02</span>
							<h4>Gluten free food</h4>
							<p>We value your health over anything else and so we provide
								you gluten free pizza everyday of the year!!!</p>
						</div>
					</div>
					...
					<div class="col-lg-4 mt-4 mt-lg-0">
						<div class="box" data-aos="zoom-in" data-aos-delay="300">
							...
							<p>Proud to be ranked 7th Best Restaurant in India by
								"Indias50Best"</p>
						</div>
					</div>
				...
				<div class="row" data-aos="fade-up" data-aos-delay="100">
					<div class="col-lg-12 d-flex justify-content-center">
						<ul id="menu-flters">
							...
							<li data-filter=".filter-starters">Pizza</li>
							<li data-filter=".filter-salads">Beverage</li>
							<li data-filter=".filter-specialty">Cookie</li>
						</ul>
					</div>
				</div>
				...
				<div class="row menu-container" data-aos="fade-up"
					...
					<div class="col-lg-6 menu-item filter-starters">
						...
						<div class="menu-content">
							<a href="#">Mozzarella chilli paneer pizza</a><span>$5.95</span>
						</div>
						<div class="menu-ingredients">peppers, tomato, onions,
							cheese, paneer</div>
					</div>
					...
					<div class="col-lg-6 menu-item filter-starters">
						...
						<div class="menu-content">
							<a href="#">Extra Cheese Chicken Exotic</a><span>$7.95</span>
						</div>
						<div class="menu-ingredients">meat, onions, tomato, cheese</div>
					</div>

					<div class="col-lg-6 menu-item filter-starters">
						<img src="assets/img/menu/mozzarella.jpg" class="menu-img" alt="">
						<div class="menu-content">
							<a href="#">Black Olives Smoked Chicken</a><span>$4.95</span>
						</div>
						<div class="menu-ingredients">Black Olives, meat, onions,
							cheese,</div>
					</div>
          ...
          <div class="row">
            <div class="col-lg-8 details order-2 order-lg-1">
              ...
              <p>Eaque consequuntur consequuntur libero expedita in voluptas. Nostrum ipsam necessitatibus
                aliquam
                fugiat debitis quis velit. Eum ex maxime error in consequatur corporis atque. Eligendi
                asperiores
		...
		<section id="contact" class="contact">
			...
			<div data-aos="fade-up">
				<iframe style="border: 0; width: 100%; height: 350px;"
					src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.5078709752183!2d78.4935388!3d17.4353896!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb9a19168f39ed%3A0x8fbaf38d0f3a269d!2sRashtrapati%20Rd%2C%20Hyderabad%2C%20Telangana%20500003!5e0!3m2!1sen!2sin!4v1676693321438!5m2!1sen!2sin"
					...
					<div class="col-lg-4">
						<div class="info">
							<div class="address">
								...
								<h4>Location:</h4>
								<p>
									A1 Park Lane, RP Road <br> HY 500003, India
								</p>
							</div>
							...
							<div class="open-hours">
								...
								<h4>Open Hours:</h4>
								<p>
									Monday-Saturday:<br> 10:00 AM - 10:00 PM
								</p>
							</div>
	...
	<footer id="footer">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="footer-info">
							<h3>PizzaOven</h3>
							<p>
								A1 Park Lane, RP Road <br> HY 500003, India<br>
								<br> <strong>Phone:</strong> +91 994836337<br> <strong>Email:</strong>
								pizzaoven@admin.com<br>
							</p>
					...
					<div class="col-lg-3 col-md-6 footer-links">
						<h4>Our Services</h4>
						<ul>
							<li><i class="bx bx-chevron-right"></i> <a href="#">Home
									Delivery</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="#">Pizza
									On Service</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="#">30min
									Delivery</a></li>
		...
		<div class="container">
			<div class="copyright">
				&copy; Copyright <strong><span>PizzaOven</span></strong>. All Rights
				Reserved
			</div>
			<div class="credits">
