...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
	...
	<div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
		<div class="wrapper wrapper--w960" style="max-width: 1120px;margin-top:18px;">
			<div class="card card-2" style="display: flex;flex-direction: row;">
				<div><img style="margin: -3px;" src="https://images.pexels.com/photos/15485498/pexels-photo-15485498.jpeg?auto=compress&cs=tinysrgb&w=400"></div>
<!-- 				<div  class="card-heading"><img src="https://images.pexels.com/photos/15485498/pexels-photo-15485498.jpeg?auto=compress&cs=tinysrgb&w=600"></div>
 -->				<div class="card-body">
